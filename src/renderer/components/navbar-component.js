...
export class NavbarComponent extends HTMLElement {
  ...
  renderNavigation(currentPage) {
    ...
    const navItems = [
      ...
      { label: 'Contabilidad', page: 'contabilidad', icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M12 7h.01M3 5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5z', isActive: currentPage === 'contabilidad' }
    ];
  ...
  renderAdminDropdown() {
    ...
    `;
    right.innerHTML = '<a href="#administracion" data-nav-item="administracion" class="block px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">Tratamientos</a>';
  }
